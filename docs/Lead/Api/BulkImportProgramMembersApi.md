# NecLimDul\MarketoRest\Lead\BulkImportProgramMembersApi
...
```php
getImportProgramMemberFailuresUsingGET($batch_id): object
```
...
```php
getImportProgramMemberStatusUsingGET($batch_id): \NecLimDul\MarketoRest\Lead\Model\ResponseOfImportProgramMemberResponse
```
...
```php
getImportProgramMemberWarningsUsingGET($batch_id): object
```
...
```php
importProgramMemberUsingPOST($program_id, $program_member_status, $format, $file): \NecLimDul\MarketoRest\Lead\Model\ResponseOfImportProgramMemberResponse
```
