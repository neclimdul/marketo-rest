...
```php
createProgramMemberFieldUsingPOST($create_lead_field_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfCreateLeadField
```
...
```php
deleteProgramMemberUsingPOST($program_id, $delete_program_member_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMemberDelete
```
...
```php
describeProgramMemberUsingGET2(): \NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMemberAttributes2
```
...
```php
getProgramMemberFieldByNameUsingGET($field_api_name): \NecLimDul\MarketoRest\Lead\Model\ResponseOfLeadField
```
...
```php
getProgramMemberFieldsUsingGET($batch_size, $next_page_token): \NecLimDul\MarketoRest\Lead\Model\ResponseOfLeadField
```
...
```php
getProgramMembersUsingGET($program_id, $filter_type, $filter_values, $start_at, $end_at, $fields, $batch_size, $next_page_token): \NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMember
```
...
```php
syncProgramMemberDataUsingPOST($program_id, $sync_program_member_data_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMemberData
```
...
```php
syncProgramMemberStatusUsingPOST($program_id, $sync_program_member_status_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMemberStatus
```
...
```php
updateProgramMemberFieldUsingPOST($field_api_name, $update_lead_field_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfUpdateLeadField
```
