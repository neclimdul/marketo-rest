...
```php
getOpportunityFieldByNameUsingGET($field_api_name): \NecLimDul\MarketoRest\Lead\Model\ResponseOfLeadField
```
...
```php
getOpportunityFieldsUsingGET($batch_size, $next_page_token): \NecLimDul\MarketoRest\Lead\Model\ResponseOfLeadField
```
