...
```php
addNamedAccountListMembersUsingPOST($id, $add_named_account_list_member_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount
```
...
```php
deleteNamedAccountListsUsingPOST($delete_named_account_list_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccountList
```
...
```php
getNamedAccountListMembersUsingGET($id, $fields, $batch_size, $next_page_token): \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount
```
...
```php
getNamedAccountListsUsingGET($filter_type, $filter_values, $batch_size, $next_page_token): \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccountList
```
...
```php
removeNamedAccountListMembersUsingPOST($id, $remove_named_account_list_member_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount
```
...
```php
syncNamedAccountListsUsingPOST($sync_named_account_list_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccountList
```
