...
```php
cancelExportLeadsUsingPOST($export_id): \NecLimDul\MarketoRest\Lead\Model\ResponseOfExportResponse
```
...
```php
createExportLeadsUsingPOST($export_lead_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfExportResponse
```
...
```php
enqueueExportLeadsUsingPOST($export_id): \NecLimDul\MarketoRest\Lead\Model\ResponseOfExportResponse
```
...
```php
getExportLeadsFileUsingGET($export_id, $range): object
```
...
```php
getExportLeadsStatusUsingGET($export_id): \NecLimDul\MarketoRest\Lead\Model\ResponseOfExportResponse
```
...
```php
getExportLeadsUsingGET($status, $batch_size, $next_page_token): \NecLimDul\MarketoRest\Lead\Model\ResponseOfExportResponseWithToken
```
