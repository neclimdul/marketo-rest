...
```php
addLeadsToListUsingPOST($list_id, $id, $list_operation_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfListOperationOutputData
```
...
```php
areLeadsMemberOfListUsingGET($list_id, $id, $list_operation_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfListOperationOutputData
```
...
```php
getLeadsByListIdUsingGET1($list_id, $fields, $batch_size, $next_page_token): \NecLimDul\MarketoRest\Lead\Model\ResponseOfLead
```
...
```php
getListByIdUsingGET($list_id): \NecLimDul\MarketoRest\Lead\Model\ResponseOfStaticList
```
...
```php
getListsUsingGET($id, $name, $program_name, $workspace_name, $batch_size, $next_page_token): \NecLimDul\MarketoRest\Lead\Model\ResponseOfStaticList
```
...
```php
removeLeadsFromListUsingDELETE($list_id, $id, $list_operation_request): \NecLimDul\MarketoRest\Lead\Model\ResponseOfListOperationOutputData
```
