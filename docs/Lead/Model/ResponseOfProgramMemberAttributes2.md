...
**result** | [**\NecLimDul\MarketoRest\Lead\Model\ProgramMemberAttribute2[]**](ProgramMemberAttribute2.md) | Array of results for individual records in the operation, may be empty |
