...
**result** | [**\NecLimDul\MarketoRest\Lead\Model\ImportCustomObjectResponse[]**](ImportCustomObjectResponse.md) | Array of results for individual records in the operation, may be empty | 
