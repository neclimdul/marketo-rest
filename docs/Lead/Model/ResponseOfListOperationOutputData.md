...
**result** | [**\MarketoRest\Lead\Model\ListOperationOutputData[]**](ListOperationOutputData.md) | Array of results for individual records in the operation, may be empty | 
