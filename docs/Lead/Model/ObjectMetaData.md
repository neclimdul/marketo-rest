...
**searchable_fields** | **string[][]** | List of fields valid for use as a filter type in a query |
**updated_at** | **\DateTime** | Datetime when the object type was most recently updated |
