...
**result** | [**\NecLimDul\MarketoRest\Lead\Model\ProgramMemberStatusResponse[]**](ProgramMemberStatusResponse.md) | Array of results for individual records in the operation, may be empty | 
