...
**result** | [**\NecLimDul\MarketoRest\Lead\Model\CustomActivityType[]**](CustomActivityType.md) | Array of results for individual records in the operation, may be empty | 
