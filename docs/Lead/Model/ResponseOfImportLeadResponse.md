...
**result** | [**\NecLimDul\MarketoRest\Lead\Model\ImportLeadResponse[]**](ImportLeadResponse.md) | Array of results for individual records in the operation, may be empty | 
