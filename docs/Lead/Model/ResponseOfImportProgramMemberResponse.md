...
**result** | [**\MarketoRest\Lead\Model\ImportProgramMemberResponse[]**](ImportProgramMemberResponse.md) | Array of results for individual records in the operation, may be empty | 
