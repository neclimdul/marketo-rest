...
**result** | [**\MarketoRest\Lead\Model\ChangeLeadProgramStatusOutputData[]**](ChangeLeadProgramStatusOutputData.md) | Array of results for individual records in the operation, may be empty | 
