...
**result** | [**\NecLimDul\MarketoRest\Lead\Model\ProgramMemberDeleteResponse[]**](ProgramMemberDeleteResponse.md) | Array of results for individual records in the operation, may be empty |
