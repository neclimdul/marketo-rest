...
------------ | ------------- | ------------- | -------------
**start_at** | **\DateTime** | Datetime of the first scheduled campaign to run. Required if setting recurrence. Not required to create a smart campaign that has no recurrence |
**end_at** | **\DateTime** | Datetime after which no further runs will be automatically scheduled |
