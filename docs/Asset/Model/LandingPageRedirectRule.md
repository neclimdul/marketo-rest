...
**created_at** | **\DateTime** | Datetime the landing page redirect rule was created |
**updated_at** | **\DateTime** | Datetime the landing page redirect rule was most recently updated |
