...
```php
approveLandingPageTemplateUsingPOST($id): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
```
...
```php
cloneLpTemplateUsingPOST($id, $folder, $name, $description): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
```
...
```php
createLpTemplateUsingPOST($folder, $name, $description, $enable_munchkin, $template_type): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
```
...
```php
deleteLpTemplateUsingPOST($id): \NecLimDul\MarketoRest\Asset\Model\ResponseOfIdResponse
```
...
```php
discardDraftUsingPOST2($id): \NecLimDul\MarketoRest\Asset\Model\ResponseOfIdResponse
```
...
```php
getLandingPageTemplateByIdUsingGET($id, $status): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
```
...
```php
getLandingPageTemplateByNameUsingGET($name): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
```
...
```php
getLandingPageTemplateContentUsingGET($id, $status): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateGetContentResponse
```
...
```php
getLandingPageTemplatesUsingGET($max_return, $offset, $status, $folder): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
```
...
```php
unapproveLandingPageTemplateUsingPOST($id): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
```
...
```php
updateLandingPageTemplateContentUsingPOST($id, $content): \NecLimDul\MarketoRest\Asset\Model\ResponseOfIdResponse
```
...
```php
updateLpTemplateUsingPOST($id, $description, $enable_munchkin, $name): \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
```
