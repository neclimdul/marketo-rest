...
$id = 56; // int | id
$positions = array(new \NecLimDul\MarketoRest\Asset\Model\\NecLimDul\MarketoRest\Asset\Model\UpdateFieldPosition()); // \NecLimDul\MarketoRest\Asset\Model\UpdateFieldPosition[]
