...
$costs = array(new \NecLimDul\MarketoRest\Asset\Model\\NecLimDul\MarketoRest\Asset\Model\CostRequest()); // \NecLimDul\MarketoRest\Asset\Model\CostRequest[] | Lists of associated period costs
$description = 'description_example'; // string
