...
```php
createStaticListUsingPOST($name, $folder, $description): \NecLimDul\MarketoRest\Asset\Model\ResponseOfStaticListResponse
```
...
```php
deleteStaticListByIdUsingPOST($id): \NecLimDul\MarketoRest\Asset\Model\ResponseOfIdResponse
```
...
```php
getStaticListByIdUsingGET($id): \NecLimDul\MarketoRest\Asset\Model\ResponseOfStaticListResponse
```
...
```php
getStaticListByNameUsingGET($name): \NecLimDul\MarketoRest\Asset\Model\ResponseOfStaticListResponse
```
...
```php
getStaticListsUsingGET($folder, $offset, $max_return, $earliest_updated_at, $latest_updated_at): \NecLimDul\MarketoRest\Asset\Model\ResponseOfStaticListResponse
```
...
```php
updateStaticListUsingPOST($id, $description, $name): \NecLimDul\MarketoRest\Asset\Model\ResponseOfStaticListResponse
```
