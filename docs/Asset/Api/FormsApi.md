...
$id = 56; // int | id
$thankyou = array(new \NecLimDul\MarketoRest\Asset\Model\\NecLimDul\MarketoRest\Asset\Model\ThankYouPageRequest()); // \NecLimDul\MarketoRest\Asset\Model\ThankYouPageRequest[] | JSON array of followup rules
