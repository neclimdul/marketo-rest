...
class CompaniesApiTest extends TestCase
{
    ...
    public function provideDeleteCompaniesUsingPOST(): \Generator
    {
    ...
    public function provideDescribeUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetCompaniesUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetCompanyFieldByNameUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetCompanyFieldsUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideSyncCompaniesUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
