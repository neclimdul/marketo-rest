...
class OpportunitiesApiTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = new OpportunitiesApi($this->client->reveal());
        $this->setAssertedApiException(ApiException::class);
        // Add a key, so we can assert its included.
        $this->sot->getConfig()->setApiKey('Authorization', 'secure-key');
    }

    public function provideDeleteOpportunitiesUsingPOST(): \Generator
    {
    ...
    public function provideDeleteOpportunityRolesUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDescribeOpportunityRoleUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDescribeUsingGET4(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetOpportunitiesUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetOpportunityFieldByNameUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetOpportunityFieldsUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetOpportunityRolesUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideSyncOpportunitiesUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideSyncOpportunityRolesUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
