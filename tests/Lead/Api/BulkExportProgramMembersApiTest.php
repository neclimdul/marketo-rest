...
class BulkExportProgramMembersApiTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = new BulkExportProgramMembersApi($this->client->reveal());
        $this->setAssertedApiException(ApiException::class);
    ...
    public function testHostIndex(): void
    {
        ...
        $sot = new BulkExportProgramMembersApi($this->client->reveal(), null, null, 5);
    ...
    public function testGetConfig(): void
    {
        ...
        $sot = new BulkExportProgramMembersApi($this->client->reveal(), $config, null, 5);
