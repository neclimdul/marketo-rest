...
class CustomObjectsApiTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = new CustomObjectsApi($this->client->reveal());
        $this->setAssertedApiException(ApiException::class);
        // Add a key, so we can assert its included.
        $this->sot->getConfig()->setApiKey('Authorization', 'secure-key');
    }

    public function provideAddCustomObjectTypeFieldsUsingPOST(): \Generator
    {
    ...
    public function provideApproveCustomObjectTypeUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDeleteCustomObjectTypeFieldsUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDeleteCustomObjectTypeUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDeleteCustomObjectsUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDescribeCustomObjectTypeUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDescribeUsingGET1(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDiscardCustomObjectTypeUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetCustomObjectTypeDependentAssetsUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetCustomObjectTypeFieldDataTypesUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetCustomObjectTypeLinkableObjectsUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetCustomObjectsUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideListCustomObjectTypesUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideListCustomObjectsUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideSyncCustomObjectTypeUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideSyncCustomObjectsUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUpdateCustomObjectTypeFieldUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
