...
/**
 * ResponseOfLeadAttributeTest class file.
 *
 ...
 */
#[CoversClass(ResponseOfLeadAttribute::class)]
class ResponseOfLeadAttributeTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfLeadAttribute $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfLeadAttribute::class, null);
    }
     ...
     */
    public function testResponseOfLeadAttribute(): void
    {
        $this->assertInstanceOf(ResponseOfLeadAttribute::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfLeadAttribute::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfLeadAttribute', $this->sot->getModelName());
    }
