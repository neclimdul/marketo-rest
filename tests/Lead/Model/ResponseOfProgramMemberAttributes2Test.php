...
/**
 * ResponseOfProgramMemberAttributes2Test class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMemberAttributes2;
...
/**
 * ResponseOfProgramMemberAttributes2Test
 *
 ...
 */
#[CoversClass(ResponseOfProgramMemberAttributes2::class)]
class ResponseOfProgramMemberAttributes2Test extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfProgramMemberAttributes2 $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfProgramMemberAttributes2::class, null);
    }

    /**
     * Test "ResponseOfProgramMemberAttributes2"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfProgramMemberAttributes2(): void
    {
        $this->assertInstanceOf(ResponseOfProgramMemberAttributes2::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfProgramMemberAttributes2::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfProgramMemberAttributes2', $this->sot->getModelName());
    }
