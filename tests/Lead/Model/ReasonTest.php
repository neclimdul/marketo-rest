...
class ReasonTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(Reason::class, null);
    }
    ...
    {
        $this->assertInstanceOf(Reason::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, Reason::openAPITypes());
    }
    ...
    {
        $this->assertEquals('Reason', $this->sot->getModelName());
    }
