...
/**
 * ResponseOfLeadAttribute2Test class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfLeadAttribute2;
 ...
 */
#[CoversClass(ResponseOfLeadAttribute2::class)]
class ResponseOfLeadAttribute2Test extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfLeadAttribute2 $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfLeadAttribute2::class, null);
    }
     ...
     */
    public function testResponseOfLeadAttribute2(): void
    {
        $this->assertInstanceOf(ResponseOfLeadAttribute2::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfLeadAttribute2::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfLeadAttribute2', $this->sot->getModelName());
    }
