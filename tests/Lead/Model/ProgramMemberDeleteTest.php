...
/**
 * ProgramMemberDeleteTest class file.
 *
 ...
 */
#[CoversClass(ProgramMemberDelete::class)]
class ProgramMemberDeleteTest extends TestCase
{
    use FakeValuesTrait;

    private ProgramMemberDelete $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ProgramMemberDelete::class, null);
    }
    ...
    {
        $this->assertEquals($this->types, ProgramMemberDelete::openAPITypes());
    }
