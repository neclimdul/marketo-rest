...
/**
 * ResponseOfStaticListTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfStaticList;
 ...
 */
#[CoversClass(ResponseOfStaticList::class)]
class ResponseOfStaticListTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfStaticList $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfStaticList::class, null);
    }

    /**
     * Test "ResponseOfStaticList"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfStaticList(): void
    {
        $this->assertInstanceOf(ResponseOfStaticList::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfStaticList::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfStaticList', $this->sot->getModelName());
    }
