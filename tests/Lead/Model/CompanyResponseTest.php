...
/**
 * CompanyResponseTest class file.
 *
...
class CompanyResponseTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(CompanyResponse::class, null);
    }
    ...
    {
        $this->assertInstanceOf(CompanyResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, CompanyResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('CompanyResponse', $this->sot->getModelName());
    }
