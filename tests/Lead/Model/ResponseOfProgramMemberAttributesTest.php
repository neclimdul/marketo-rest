...
/**
 * ResponseOfProgramMemberAttributesTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMemberAttributes;
 ...
 */
#[CoversClass(ResponseOfProgramMemberAttributes::class)]
class ResponseOfProgramMemberAttributesTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfProgramMemberAttributes $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfProgramMemberAttributes::class, null);
    }
     ...
     */
    public function testResponseOfProgramMemberAttributes(): void
    {
        $this->assertInstanceOf(ResponseOfProgramMemberAttributes::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfProgramMemberAttributes::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfProgramMemberAttributes', $this->sot->getModelName());
    }
