 ...
 */
#[CoversClass(ResponseOfLead::class)]
class ResponseOfLeadTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfLead $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfLead::class, null);
    }
     ...
     */
    public function testResponseOfLead(): void
    {
        $this->assertInstanceOf(ResponseOfLead::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfLead::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfLead', $this->sot->getModelName());
    }
