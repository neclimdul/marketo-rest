...
class ExportActivityFilterTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('activityTypeIds', $attributes['activity_type_ids']);
        $this->assertEquals('primaryAttributeValueIds', $attributes['primary_attribute_value_ids']);
        $this->assertEquals('primaryAttributeValues', $attributes['primary_attribute_values']);
