...
/**
 * ResponseOfCampaignTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfCampaign;
 ...
 */
#[CoversClass(ResponseOfCampaign::class)]
class ResponseOfCampaignTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfCampaign $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\Campaign[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfCampaign::class, null);
    }

    /**
     * Test "ResponseOfCampaign"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfCampaign(): void
    {
        $this->assertInstanceOf(ResponseOfCampaign::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfCampaign::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfCampaign', $this->sot->getModelName());
    }
