...
/**
 * ResponseOfProgramsTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfPrograms;
 ...
 */
#[CoversClass(ResponseOfPrograms::class)]
class ResponseOfProgramsTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfPrograms $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\Program[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfPrograms::class, null);
    }

    /**
     * Test "ResponseOfPrograms"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfPrograms(): void
    {
        $this->assertInstanceOf(ResponseOfPrograms::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfPrograms::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfPrograms', $this->sot->getModelName());
    }
