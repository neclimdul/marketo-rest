...
/**
 * ResponseOfSmartCampaignsTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfSmartCampaigns;
 ...
 */
#[CoversClass(ResponseOfSmartCampaigns::class)]
class ResponseOfSmartCampaignsTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfSmartCampaigns $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\SmartCampaign[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfSmartCampaigns::class, null);
    }
     ...
     */
    public function testResponseOfSmartCampaigns(): void
    {
        $this->assertInstanceOf(ResponseOfSmartCampaigns::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfSmartCampaigns::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfSmartCampaigns', $this->sot->getModelName());
    }
