...
/**
 * ResponseOfNamedAccountListTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccountList;
 ...
 */
#[CoversClass(ResponseOfNamedAccountList::class)]
class ResponseOfNamedAccountListTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfNamedAccountList $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\NamedAccountList[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfNamedAccountList::class, null);
    }
     ...
     */
    public function testResponseOfNamedAccountList(): void
    {
        $this->assertInstanceOf(ResponseOfNamedAccountList::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfNamedAccountList::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfNamedAccountList', $this->sot->getModelName());
    }
