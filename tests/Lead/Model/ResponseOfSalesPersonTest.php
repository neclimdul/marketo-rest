...
/**
 * ResponseOfSalesPersonTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfSalesPerson;
 ...
 */
#[CoversClass(ResponseOfSalesPerson::class)]
class ResponseOfSalesPersonTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfSalesPerson $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\SalesPerson[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfSalesPerson::class, null);
    }
     ...
     */
    public function testResponseOfSalesPerson(): void
    {
        $this->assertInstanceOf(ResponseOfSalesPerson::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfSalesPerson::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfSalesPerson', $this->sot->getModelName());
    }
