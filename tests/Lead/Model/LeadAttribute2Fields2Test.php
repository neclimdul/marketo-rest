...
/**
 * LeadAttribute2Fields2Test class file.
 *
 ...
 */
#[CoversClass(LeadAttribute2Fields2::class)]
class LeadAttribute2Fields2Test extends TestCase
{
    use FakeValuesTrait;

    private LeadAttribute2Fields2 $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(LeadAttribute2Fields2::class, null);
    }
    ...
    {
        $this->assertInstanceOf(LeadAttribute2Fields2::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, LeadAttribute2Fields2::openAPITypes());
    }
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('crmManaged', $attributes['crm_managed']);
    }
    ...
    {
        $this->assertEquals('LeadAttribute2Fields2', $this->sot->getModelName());
    }
