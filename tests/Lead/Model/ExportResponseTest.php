...
class ExportResponseTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('errorMsg', $attributes['error_msg']);
        $this->assertEquals('exportId', $attributes['export_id']);
        $this->assertEquals('fileSize', $attributes['file_size']);
        $this->assertEquals('fileChecksum', $attributes['file_checksum']);
        $this->assertEquals('finishedAt', $attributes['finished_at']);
        $this->assertEquals('format', $attributes['format']);
        $this->assertEquals('numberOfRecords', $attributes['number_of_records']);
        $this->assertEquals('queuedAt', $attributes['queued_at']);
        $this->assertEquals('startedAt', $attributes['started_at']);
