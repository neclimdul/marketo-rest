...
/**
 * ResponseOfActivityTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfActivity;
 ...
 */
#[CoversClass(ResponseOfActivity::class)]
class ResponseOfActivityTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfActivity $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfActivity::class, null);
    }
     ...
     */
    public function testResponseOfActivity(): void
    {
        $this->assertInstanceOf(ResponseOfActivity::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfActivity::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfActivity', $this->sot->getModelName());
    }
