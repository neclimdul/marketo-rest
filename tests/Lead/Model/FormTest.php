...
class FormTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('leadFormFields', $attributes['lead_form_fields']);
        $this->assertEquals('visitorData', $attributes['visitor_data']);
        $this->assertEquals('cookie', $attributes['cookie']);
    }
