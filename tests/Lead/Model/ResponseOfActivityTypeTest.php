...
/**
 * ResponseOfActivityTypeTest class file.
 *
 ...
 */
#[CoversClass(ResponseOfActivityType::class)]
class ResponseOfActivityTypeTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfActivityType $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\ActivityType[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfActivityType::class, null);
    }

    /**
     * Test "ResponseOfActivityType"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfActivityType(): void
    {
        $this->assertInstanceOf(ResponseOfActivityType::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfActivityType::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfActivityType', $this->sot->getModelName());
    }
