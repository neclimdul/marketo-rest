...
/**
 * ResponseOfPushLeadToMarketoTest class file.
 *
 ...
 */
#[CoversClass(ResponseOfPushLeadToMarketo::class)]
class ResponseOfPushLeadToMarketoTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfPushLeadToMarketo $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfPushLeadToMarketo::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ResponseOfPushLeadToMarketo::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfPushLeadToMarketo::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfPushLeadToMarketo', $this->sot->getModelName());
    }
