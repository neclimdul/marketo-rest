...
/**
 * ResponseOfCustomActivityTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfCustomActivity;
 ...
 */
#[CoversClass(ResponseOfCustomActivity::class)]
class ResponseOfCustomActivityTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfCustomActivity $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\CustomActivity[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfCustomActivity::class, null);
    }

    /**
     * Test "ResponseOfCustomActivity"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfCustomActivity(): void
    {
        $this->assertInstanceOf(ResponseOfCustomActivity::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfCustomActivity::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfCustomActivity', $this->sot->getModelName());
    }
