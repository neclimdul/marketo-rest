...
/**
 * ResponseOfNamedAccountTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount;
 ...
 */
#[CoversClass(ResponseOfNamedAccount::class)]
class ResponseOfNamedAccountTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfNamedAccount $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfNamedAccount::class, null);
    }

    /**
     * Test "ResponseOfNamedAccount"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfNamedAccount(): void
    {
        $this->assertInstanceOf(ResponseOfNamedAccount::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfNamedAccount::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfNamedAccount', $this->sot->getModelName());
    }
