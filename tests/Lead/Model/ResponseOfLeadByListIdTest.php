...
/**
 * ResponseOfLeadByListIdTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfLeadByListId;
 ...
 */
#[CoversClass(ResponseOfLeadByListId::class)]
class ResponseOfLeadByListIdTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfLeadByListId $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfLeadByListId::class, null);
    }
     ...
     */
    public function testResponseOfLeadByListId(): void
    {
        $this->assertInstanceOf(ResponseOfLeadByListId::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfLeadByListId::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfLeadByListId', $this->sot->getModelName());
    }
