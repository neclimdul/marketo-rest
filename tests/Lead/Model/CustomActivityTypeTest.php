...
class CustomActivityTypeTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('filterName', $attributes['filter_name']);
        $this->assertEquals('id', $attributes['id']);
        $this->assertEquals('name', $attributes['name']);
        $this->assertEquals('primaryAttribute', $attributes['primary_attribute']);
        $this->assertEquals('status', $attributes['status']);
        $this->assertEquals('triggerName', $attributes['trigger_name']);
