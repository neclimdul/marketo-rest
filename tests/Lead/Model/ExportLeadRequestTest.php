...
/**
 * ExportLeadRequestTest class file.
 *
 ...
 */
#[CoversClass(ExportLeadRequest::class)]
class ExportLeadRequestTest extends TestCase
{
    use FakeValuesTrait;

    private ExportLeadRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ExportLeadRequest::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ExportLeadRequest::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ExportLeadRequest::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ExportLeadRequest', $this->sot->getModelName());
    }
