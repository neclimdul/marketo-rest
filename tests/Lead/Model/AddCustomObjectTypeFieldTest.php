...
/**
 * AddCustomObjectTypeFieldTest class file.
 *
 ...
 */
#[CoversClass(AddCustomObjectTypeField::class)]
class AddCustomObjectTypeFieldTest extends TestCase
{
    use FakeValuesTrait;

    private AddCustomObjectTypeField $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(AddCustomObjectTypeField::class, null);
    }
    ...
    {
        $this->assertEquals($this->types, AddCustomObjectTypeField::openAPITypes());
    }
