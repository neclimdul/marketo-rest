...
/**
 * ResponseOfImportLeadResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfImportLeadResponse;
 ...
 */
#[CoversClass(ResponseOfImportLeadResponse::class)]
class ResponseOfImportLeadResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfImportLeadResponse $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\ImportLeadResponse[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfImportLeadResponse::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ResponseOfImportLeadResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfImportLeadResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfImportLeadResponse', $this->sot->getModelName());
    }
