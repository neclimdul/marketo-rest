...
/**
 * ResponseOfListOperationOutputDataTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfListOperationOutputData;
 ...
 */
#[CoversClass(ResponseOfListOperationOutputData::class)]
class ResponseOfListOperationOutputDataTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfListOperationOutputData $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfListOperationOutputData::class, null);
    }
     ...
     */
    public function testResponseOfListOperationOutputData(): void
    {
        $this->assertInstanceOf(ResponseOfListOperationOutputData::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfListOperationOutputData::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfListOperationOutputData', $this->sot->getModelName());
    }
