...
/**
 * ResponseOfProgramMemberStatusTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMemberStatus;
...
/**
 * ResponseOfProgramMemberStatusTest
 *
 ...
 */
#[CoversClass(ResponseOfProgramMemberStatus::class)]
class ResponseOfProgramMemberStatusTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfProgramMemberStatus $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfProgramMemberStatus::class, null);
    }

    /**
     * Test "ResponseOfProgramMemberStatus"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfProgramMemberStatus(): void
    {
        $this->assertInstanceOf(ResponseOfProgramMemberStatus::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfProgramMemberStatus::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfProgramMemberStatus', $this->sot->getModelName());
    }
