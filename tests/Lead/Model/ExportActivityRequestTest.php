...
/**
 * ExportActivityRequestTest class file.
 *
 ...
 */
#[CoversClass(ExportActivityRequest::class)]
class ExportActivityRequestTest extends TestCase
{
    use FakeValuesTrait;

    private ExportActivityRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ExportActivityRequest::class, null);
    }
    ...
    {
        $this->assertEquals($this->types, ExportActivityRequest::openAPITypes());
    }
