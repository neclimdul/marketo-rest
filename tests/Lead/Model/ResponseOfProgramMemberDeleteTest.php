...
/**
 * ResponseOfProgramMemberDeleteTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMemberDelete;
...
/**
 * ResponseOfProgramMemberDeleteTest
 *
 ...
 */
#[CoversClass(ResponseOfProgramMemberDelete::class)]
class ResponseOfProgramMemberDeleteTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfProgramMemberDelete $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\ProgramMemberDeleteResponse[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfProgramMemberDelete::class, null);
    }

    /**
     * Test "ResponseOfProgramMemberDelete"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfProgramMemberDelete(): void
    {
        $this->assertInstanceOf(ResponseOfProgramMemberDelete::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfProgramMemberDelete::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfProgramMemberDelete', $this->sot->getModelName());
    }
