...
/**
 * ResponseWithoutResultTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseWithoutResult;
 ...
 */
#[CoversClass(ResponseWithoutResult::class)]
class ResponseWithoutResultTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseWithoutResult $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseWithoutResult::class, null);
    }
     ...
     */
    public function testResponseWithoutResult(): void
    {
        $this->assertInstanceOf(ResponseWithoutResult::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseWithoutResult::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseWithoutResult', $this->sot->getModelName());
    }
