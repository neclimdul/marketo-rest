 ...
 */
#[CoversClass(ResponseOfVoid::class)]
class ResponseOfVoidTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfVoid $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfVoid::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ResponseOfVoid::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfVoid::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfVoid', $this->sot->getModelName());
    }
