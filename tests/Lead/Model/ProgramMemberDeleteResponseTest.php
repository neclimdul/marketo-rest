...
/**
 * ProgramMemberDeleteResponseTest class file.
 *
 ...
 */
#[CoversClass(ProgramMemberDeleteResponse::class)]
class ProgramMemberDeleteResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ProgramMemberDeleteResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ProgramMemberDeleteResponse::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ProgramMemberDeleteResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ProgramMemberDeleteResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ProgramMemberDeleteResponse', $this->sot->getModelName());
    }
