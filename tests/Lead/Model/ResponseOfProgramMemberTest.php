...
/**
 * ResponseOfProgramMemberTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfProgramMember;
 ...
 */
#[CoversClass(ResponseOfProgramMember::class)]
class ResponseOfProgramMemberTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfProgramMember $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\ProgramMember[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfProgramMember::class, null);
    }

    /**
     * Test "ResponseOfProgramMember"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfProgramMember(): void
    {
        $this->assertInstanceOf(ResponseOfProgramMember::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfProgramMember::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfProgramMember', $this->sot->getModelName());
    }
