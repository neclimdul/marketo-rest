...
use NecLimDul\MarketoRest\Lead\Model\PushLead;
 ...
 */
#[CoversClass(PushLead::class)]
class PushLeadTest extends TestCase
{
    use FakeValuesTrait;

    private PushLead $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(PushLead::class, null);
    }
    ...
    {
        $this->assertInstanceOf(PushLead::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, PushLead::openAPITypes());
    }
    ...
    {
        $this->assertEquals('PushLead', $this->sot->getModelName());
    }
