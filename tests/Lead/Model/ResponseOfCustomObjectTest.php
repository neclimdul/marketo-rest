...
/**
 * ResponseOfCustomObjectTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfCustomObject;
 ...
 */
#[CoversClass(ResponseOfCustomObject::class)]
class ResponseOfCustomObjectTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfCustomObject $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfCustomObject::class, null);
    }
     ...
     */
    public function testResponseOfCustomObject(): void
    {
        $this->assertInstanceOf(ResponseOfCustomObject::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfCustomObject::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfCustomObject', $this->sot->getModelName());
    }
