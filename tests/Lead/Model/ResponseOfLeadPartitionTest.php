...
/**
 * ResponseOfLeadPartitionTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfLeadPartition;
 ...
 */
#[CoversClass(ResponseOfLeadPartition::class)]
class ResponseOfLeadPartitionTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfLeadPartition $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\LeadPartition[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfLeadPartition::class, null);
    }
     ...
     */
    public function testResponseOfLeadPartition(): void
    {
        $this->assertInstanceOf(ResponseOfLeadPartition::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfLeadPartition::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfLeadPartition', $this->sot->getModelName());
    }
