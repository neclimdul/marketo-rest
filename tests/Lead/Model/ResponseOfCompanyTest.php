...
/**
 * ResponseOfCompanyTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfCompany;
 ...
 */
#[CoversClass(ResponseOfCompany::class)]
class ResponseOfCompanyTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfCompany $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfCompany::class, null);
    }
     ...
     */
    public function testResponseOfCompany(): void
    {
        $this->assertInstanceOf(ResponseOfCompany::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfCompany::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfCompany', $this->sot->getModelName());
    }
