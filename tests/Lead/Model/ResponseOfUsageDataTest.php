...
/**
 * ResponseOfUsageDataTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfUsageData;
 ...
 */
#[CoversClass(ResponseOfUsageData::class)]
class ResponseOfUsageDataTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfUsageData $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfUsageData::class, null);
    }
     ...
     */
    public function testResponseOfUsageData(): void
    {
        $this->assertInstanceOf(ResponseOfUsageData::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfUsageData::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfUsageData', $this->sot->getModelName());
    }
