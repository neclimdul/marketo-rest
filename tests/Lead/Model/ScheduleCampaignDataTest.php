...
class ScheduleCampaignDataTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('cloneToProgramName', $attributes['clone_to_program_name']);
        $this->assertEquals('runAt', $attributes['run_at']);
        $this->assertEquals('tokens', $attributes['tokens']);
    }
