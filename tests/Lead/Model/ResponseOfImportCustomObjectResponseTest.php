...
/**
 * ResponseOfImportCustomObjectResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfImportCustomObjectResponse;
 ...
 */
#[CoversClass(ResponseOfImportCustomObjectResponse::class)]
class ResponseOfImportCustomObjectResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfImportCustomObjectResponse $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\ImportCustomObjectResponse[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfImportCustomObjectResponse::class, null);
    }
     ...
     */
    public function testResponseOfImportCustomObjectResponse(): void
    {
        $this->assertInstanceOf(ResponseOfImportCustomObjectResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfImportCustomObjectResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfImportCustomObjectResponse', $this->sot->getModelName());
    }
