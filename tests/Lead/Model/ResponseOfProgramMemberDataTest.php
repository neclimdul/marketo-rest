...
/**
 * ResponseOfProgramMemberDataTest class file.
 *
 ...
 */
#[CoversClass(ResponseOfProgramMemberData::class)]
class ResponseOfProgramMemberDataTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfProgramMemberData $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfProgramMemberData::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ResponseOfProgramMemberData::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfProgramMemberData::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfProgramMemberData', $this->sot->getModelName());
    }
