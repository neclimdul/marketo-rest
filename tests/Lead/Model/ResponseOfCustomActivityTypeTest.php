...
/**
 * ResponseOfCustomActivityTypeTest class file.
 *
...
use NecLimDul\MarketoRest\Lead\Model\ResponseOfCustomActivityType;
...
/**
 * ResponseOfCustomActivityTypeTest
 *
 ...
 */
#[CoversClass(ResponseOfCustomActivityType::class)]
class ResponseOfCustomActivityTypeTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfCustomActivityType $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Lead\Model\CustomActivityType[]',
        'success' => 'bool',
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfCustomActivityType::class, null);
    }

    /**
     * Test "ResponseOfCustomActivityType"
     *
     * @legacy-covers ::__construct
     */
    public function testResponseOfCustomActivityType(): void
    {
        $this->assertInstanceOf(ResponseOfCustomActivityType::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfCustomActivityType::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfCustomActivityType', $this->sot->getModelName());
    }
