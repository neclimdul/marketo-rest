...
/**
 * CloneProgramRequestTest class file.
 *
 ...
 */
#[CoversClass(CloneProgramRequest::class)]
class CloneProgramRequestTest extends TestCase
{
    use FakeValuesTrait;

    private CloneProgramRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(CloneProgramRequest::class, null);
    }
    ...
    {
        $this->assertEquals($this->types, CloneProgramRequest::openAPITypes());
    }
