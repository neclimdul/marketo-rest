...
/**
 * SmartListResponseTest class file.
 *
 ...
 */
#[CoversClass(SmartListResponse::class)]
class SmartListResponseTest extends TestCase
{
    use FakeValuesTrait;

    private SmartListResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(SmartListResponse::class, null);
    }
    ...
    {
        $this->assertEquals($this->types, SmartListResponse::openAPITypes());
    }
