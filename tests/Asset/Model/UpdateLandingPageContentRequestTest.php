...
/**
 * UpdateLandingPageContentRequestTest class file.
 *
 ...
 */
#[CoversClass(UpdateLandingPageContentRequest::class)]
class UpdateLandingPageContentRequestTest extends TestCase
{
    use FakeValuesTrait;

    private UpdateLandingPageContentRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(UpdateLandingPageContentRequest::class, null);
    }
    ...
    {
        $this->assertEquals($this->types, UpdateLandingPageContentRequest::openAPITypes());
    }
