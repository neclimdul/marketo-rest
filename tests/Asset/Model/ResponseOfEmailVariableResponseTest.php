...
/**
 * ResponseOfEmailVariableResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\ResponseOfEmailVariableResponse;
 ...
 */
#[CoversClass(ResponseOfEmailVariableResponse::class)]
class ResponseOfEmailVariableResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfEmailVariableResponse $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Asset\Model\EmailVariableResponse[]',
        'success' => 'bool',
        'warnings' => 'string[]',
    ];
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfEmailVariableResponse::class, null);
    }
     ...
     */
    public function testResponseOfEmailVariableResponse(): void
    {
        $this->assertInstanceOf(ResponseOfEmailVariableResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfEmailVariableResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfEmailVariableResponse', $this->sot->getModelName());
    }
