...
/**
 * SnippetResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\SnippetResponse;
 ...
 */
#[CoversClass(SnippetResponse::class)]
class SnippetResponseTest extends TestCase
{
    use FakeValuesTrait;

    private SnippetResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(SnippetResponse::class, null);
    }
     ...
     */
    public function testSnippetResponse(): void
    {
        $this->assertInstanceOf(SnippetResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, SnippetResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('SnippetResponse', $this->sot->getModelName());
    }
