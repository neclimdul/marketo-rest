...
/**
 * CreateLandingPageContentRequestTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\CreateLandingPageContentRequest;
 ...
 */
#[CoversClass(CreateLandingPageContentRequest::class)]
class CreateLandingPageContentRequestTest extends TestCase
{
    use FakeValuesTrait;

    private CreateLandingPageContentRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(CreateLandingPageContentRequest::class, null);
    }
    ...
    {
        $this->assertEquals($this->types, CreateLandingPageContentRequest::openAPITypes());
    }
