...
/**
 * StaticListResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\StaticListResponse;
 ...
 */
#[CoversClass(StaticListResponse::class)]
class StaticListResponseTest extends TestCase
{
    use FakeValuesTrait;

    private StaticListResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(StaticListResponse::class, null);
    }
     ...
     */
    public function testStaticListResponse(): void
    {
        $this->assertInstanceOf(StaticListResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, StaticListResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('StaticListResponse', $this->sot->getModelName());
    }
