...
/**
 * ResponseOfobjectTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\ResponseOfobject;
 ...
 */
#[CoversClass(ResponseOfobject::class)]
class ResponseOfobjectTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfobject $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfobject::class, null);
    }
     ...
     */
    public function testResponseOfobject(): void
    {
        $this->assertInstanceOf(ResponseOfobject::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfobject::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfobject', $this->sot->getModelName());
    }
