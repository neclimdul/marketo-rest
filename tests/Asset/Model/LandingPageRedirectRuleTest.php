...
class LandingPageRedirectRuleTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('redirectFromUrl', $attributes['redirect_from_url']);
        $this->assertEquals('redirectToUrl', $attributes['redirect_to_url']);
        $this->assertEquals('hostname', $attributes['hostname']);
        $this->assertEquals('redirectFrom', $attributes['redirect_from']);
        $this->assertEquals('redirectTo', $attributes['redirect_to']);
