...
/**
 * SmartListResponseWithRulesTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\SmartListResponseWithRules;
 ...
 */
#[CoversClass(SmartListResponseWithRules::class)]
class SmartListResponseWithRulesTest extends TestCase
{
    use FakeValuesTrait;

    private SmartListResponseWithRules $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(SmartListResponseWithRules::class, null);
    }
     ...
     */
    public function testSmartListResponseWithRules(): void
    {
        $this->assertInstanceOf(SmartListResponseWithRules::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, SmartListResponseWithRules::openAPITypes());
    }
    ...
    {
        $this->assertEquals('SmartListResponseWithRules', $this->sot->getModelName());
    }
