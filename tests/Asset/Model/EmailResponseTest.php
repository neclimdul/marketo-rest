 ...
 */
#[CoversClass(EmailResponse::class)]
class EmailResponseTest extends TestCase
{
    use FakeValuesTrait;

    private EmailResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(EmailResponse::class, null);
    }
    ...
    public function testOpenAPIRequired(): void
    {
        ...
        $this->assertEquals('operational', $required['operational']);
        $this->assertEquals('publish_to_msi', $required['publish_to_msi']);
        ...
        $this->assertEquals('text_only', $required['text_only']);
        $this->assertNotContains('updated_at', $required);
        $this->assertNotContains('url', $required);
        $this->assertNotContains('version', $required);
        $this->assertEquals('web_view', $required['web_view']);
        $this->assertNotContains('workspace', $required);
        $this->assertEquals('auto_copy_to_text', $required['auto_copy_to_text']);
        $this->assertEquals('pre_header', $required['pre_header']);
        $this->assertNotContains('cc_fields', $required);
    }
    ...
    public function testOpenAPIFormats(): void
    {
        ...
        $this->assertNotContains('publish_to_msi', $formats);
        ...
        $this->assertNotContains('auto_copy_to_text', $formats);
        $this->assertNotContains('pre_header', $formats);
        $this->assertNotContains('cc_fields', $formats);
    }
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('publishToMSI', $attributes['publish_to_msi']);
        ...
        $this->assertEquals('webView', $attributes['web_view']);
        $this->assertEquals('workspace', $attributes['workspace']);
        $this->assertEquals('autoCopyToText', $attributes['auto_copy_to_text']);
        $this->assertEquals('preHeader', $attributes['pre_header']);
        $this->assertEquals('ccFields', $attributes['cc_fields']);
    }
     ...
     *
     * @legacy-covers ::__construct
     * @legacy-covers ::getPublishToMsi
     * @legacy-covers ::setPublishToMsi
     * @legacy-covers ::offsetExists
     * @legacy-covers ::offsetGet
     * @legacy-covers ::offsetSet
     * @legacy-covers ::offsetUnset
     ...
     *
     * @legacy-covers ::__construct
     * @legacy-covers ::getAutoCopyToText
     * @legacy-covers ::setAutoCopyToText
     * @legacy-covers ::offsetExists
     * @legacy-covers ::offsetGet
     * @legacy-covers ::offsetSet
     * @legacy-covers ::offsetUnset
     ...
     *
     * @legacy-covers ::__construct
     * @legacy-covers ::getCcFields
     * @legacy-covers ::setCcFields
     * @legacy-covers ::offsetExists
     * @legacy-covers ::offsetGet
     * @legacy-covers ::offsetSet
     * @legacy-covers ::offsetUnset
