...
class SmartCampaignResponseTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('isSystem', $attributes['is_system']);
        $this->assertEquals('isActive', $attributes['is_active']);
        $this->assertEquals('isRequestable', $attributes['is_requestable']);
        $this->assertEquals('recurrence', $attributes['recurrence']);
        $this->assertEquals('qualificationRuleType', $attributes['qualification_rule_type']);
        $this->assertEquals('qualificationRuleInterval', $attributes['qualification_rule_interval']);
        $this->assertEquals('qualificationRuleUnit', $attributes['qualification_rule_unit']);
        $this->assertEquals('maxMembers', $attributes['max_members']);
        $this->assertEquals('isCommunicationLimitEnabled', $attributes['is_communication_limit_enabled']);
        $this->assertEquals('smartListId', $attributes['smart_list_id']);
        $this->assertEquals('flowId', $attributes['flow_id']);
        $this->assertEquals('parentProgramId', $attributes['parent_program_id']);
