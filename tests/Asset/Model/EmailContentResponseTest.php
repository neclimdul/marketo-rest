...
class EmailContentResponseTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('contentType', $attributes['content_type']);
        $this->assertEquals('htmlId', $attributes['html_id']);
        $this->assertEquals('index', $attributes['index']);
        $this->assertEquals('isLocked', $attributes['is_locked']);
        $this->assertEquals('parentHtmlId', $attributes['parent_html_id']);
