...
/**
 * ResponseOfLandingPageResponseTest class file.
 *
 ...
 */
#[CoversClass(ResponseOfLandingPageResponse::class)]
class ResponseOfLandingPageResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfLandingPageResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfLandingPageResponse::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ResponseOfLandingPageResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfLandingPageResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfLandingPageResponse', $this->sot->getModelName());
    }
