...
/**
 * ResponseOfSendSampleResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\ResponseOfSendSampleResponse;
 ...
 */
#[CoversClass(ResponseOfSendSampleResponse::class)]
class ResponseOfSendSampleResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfSendSampleResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfSendSampleResponse::class, null);
    }
     ...
     */
    public function testResponseOfSendSampleResponse(): void
    {
        $this->assertInstanceOf(ResponseOfSendSampleResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfSendSampleResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfSendSampleResponse', $this->sot->getModelName());
    }
