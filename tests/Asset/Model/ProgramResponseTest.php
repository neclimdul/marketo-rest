...
class ProgramResponseTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('channel', $attributes['channel']);
        $this->assertEquals('costs', $attributes['costs']);
        $this->assertEquals('createdAt', $attributes['created_at']);
        $this->assertEquals('description', $attributes['description']);
        $this->assertEquals('endDate', $attributes['end_date']);
        $this->assertEquals('folder', $attributes['folder']);
        $this->assertEquals('id', $attributes['id']);
        $this->assertEquals('name', $attributes['name']);
        $this->assertEquals('sfdcId', $attributes['sfdc_id']);
        $this->assertEquals('sfdcName', $attributes['sfdc_name']);
        $this->assertEquals('startDate', $attributes['start_date']);
        $this->assertEquals('status', $attributes['status']);
        $this->assertEquals('tags', $attributes['tags']);
