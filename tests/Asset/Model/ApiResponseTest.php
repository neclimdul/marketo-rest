...
use NecLimDul\MarketoRest\Asset\Model\ApiResponse;
...
class ApiResponseTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ApiResponse::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ApiResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ApiResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ApiResponse', $this->sot->getModelName());
    }
