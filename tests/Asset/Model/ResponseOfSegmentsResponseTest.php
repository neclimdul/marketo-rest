...
/**
 * ResponseOfSegmentsResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\ResponseOfSegmentsResponse;
 ...
 */
#[CoversClass(ResponseOfSegmentsResponse::class)]
class ResponseOfSegmentsResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfSegmentsResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfSegmentsResponse::class, null);
    }
     ...
     */
    public function testResponseOfSegmentsResponse(): void
    {
        $this->assertInstanceOf(ResponseOfSegmentsResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfSegmentsResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfSegmentsResponse', $this->sot->getModelName());
    }
