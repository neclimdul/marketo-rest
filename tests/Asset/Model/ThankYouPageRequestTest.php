...
/**
 * ThankYouPageRequestTest class file.
 *
 ...
 */
#[CoversClass(ThankYouPageRequest::class)]
class ThankYouPageRequestTest extends TestCase
{
    use FakeValuesTrait;

    private ThankYouPageRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ThankYouPageRequest::class, null);
    }
    ...
    public function testOpenAPIRequired(): void
    {
        ...
        $this->assertEquals('followup_type', $required['followup_type']);
        $this->assertEquals('followup_value', $required['followup_value']);
