...
/**
 * CreateFileRequestTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\CreateFileRequest;
 ...
 */
#[CoversClass(CreateFileRequest::class)]
class CreateFileRequestTest extends TestCase
{
    use FakeValuesTrait;

    private CreateFileRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(CreateFileRequest::class, null);
    }
    ...
    {
        $this->assertEquals($this->types, CreateFileRequest::openAPITypes());
    }
    ...
    public function testOpenAPIRequired(): void
    {
        ...
        $this->assertEquals('file', $required['file']);
        $this->assertEquals('folder', $required['folder']);
        $this->assertNotContains('insert_only', $required);
    ...
    public function testOpenAPIFormats(): void
    {
        ...
        $this->assertNotContains('file', $formats);
        $this->assertNotContains('folder', $formats);
        $this->assertNotContains('insert_only', $formats);
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('insertOnly', $attributes['insert_only']);
     ...
     *
     * @legacy-covers ::__construct
     * @legacy-covers ::getInsertOnly
     * @legacy-covers ::setInsertOnly
     * @legacy-covers ::offsetExists
     * @legacy-covers ::offsetGet
     * @legacy-covers ::offsetSet
     * @legacy-covers ::offsetUnset
