...
/**
 * ResponseOfSmartListResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\ResponseOfSmartListResponse;
...
/**
 * ResponseOfSmartListResponseTest
 *
 ...
 */
#[CoversClass(ResponseOfSmartListResponse::class)]
class ResponseOfSmartListResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfSmartListResponse $sot;
    ...
    private array $types = [
        ...
        'request_id' => 'string',
        'result' => '\NecLimDul\MarketoRest\Asset\Model\SmartListResponse[]',
        'success' => 'bool',
        'warnings' => 'string[]',
    ];
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfSmartListResponse::class, null);
    }
    ...
    {
        $this->assertInstanceOf(ResponseOfSmartListResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfSmartListResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfSmartListResponse', $this->sot->getModelName());
    }
