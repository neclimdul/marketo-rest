...
/**
 * UpdateSnippetRequestTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\UpdateSnippetRequest;
 ...
 */
#[CoversClass(UpdateSnippetRequest::class)]
class UpdateSnippetRequestTest extends TestCase
{
    use FakeValuesTrait;

    private UpdateSnippetRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(UpdateSnippetRequest::class, null);
    }
    ...
    {
        $this->assertInstanceOf(UpdateSnippetRequest::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, UpdateSnippetRequest::openAPITypes());
    }
    ...
    {
        $this->assertEquals('UpdateSnippetRequest', $this->sot->getModelName());
    }
