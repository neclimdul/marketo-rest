...
class UpdateLandingPageDynamicContentRequestTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('backgroundColor', $attributes['background_color']);
        $this->assertEquals('borderColor', $attributes['border_color']);
        $this->assertEquals('borderStyle', $attributes['border_style']);
        $this->assertEquals('borderWidth', $attributes['border_width']);
        $this->assertEquals('height', $attributes['height']);
        $this->assertEquals('hideDesktop', $attributes['hide_desktop']);
        $this->assertEquals('hideMobile', $attributes['hide_mobile']);
        $this->assertEquals('imageOpenNewWindow', $attributes['image_open_new_window']);
        $this->assertEquals('left', $attributes['left']);
        $this->assertEquals('linkUrl', $attributes['link_url']);
        $this->assertEquals('opacity', $attributes['opacity']);
        $this->assertEquals('segment', $attributes['segment']);
        $this->assertEquals('top', $attributes['top']);
        $this->assertEquals('type', $attributes['type']);
        $this->assertEquals('value', $attributes['value']);
        $this->assertEquals('width', $attributes['width']);
        $this->assertEquals('zIndex', $attributes['z_index']);
    }
