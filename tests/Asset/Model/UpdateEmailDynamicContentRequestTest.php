...
/**
 * UpdateEmailDynamicContentRequestTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\UpdateEmailDynamicContentRequest;
 ...
 */
#[CoversClass(UpdateEmailDynamicContentRequest::class)]
class UpdateEmailDynamicContentRequestTest extends TestCase
{
    use FakeValuesTrait;

    private UpdateEmailDynamicContentRequest $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(UpdateEmailDynamicContentRequest::class, null);
    }
    ...
    {
        $this->assertInstanceOf(UpdateEmailDynamicContentRequest::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, UpdateEmailDynamicContentRequest::openAPITypes());
    }
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('altText', $attributes['alt_text']);
        $this->assertEquals('externalUrl', $attributes['external_url']);
        ...
        $this->assertEquals('overWrite', $attributes['over_write']);
        $this->assertEquals('style', $attributes['style']);
        $this->assertEquals('type', $attributes['type']);
        $this->assertEquals('value', $attributes['value']);
        $this->assertEquals('videoUrl', $attributes['video_url']);
    ...
    {
        $this->assertEquals('UpdateEmailDynamicContentRequest', $this->sot->getModelName());
    }
