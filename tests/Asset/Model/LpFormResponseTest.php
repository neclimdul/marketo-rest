...
class LpFormResponseTest extends TestCase
{
    ...
    public function testAttributeMap(): void
    {
        ...
        $this->assertEquals('buttonLabel', $attributes['button_label']);
        $this->assertEquals('buttonLocation', $attributes['button_location']);
        ...
        $this->assertEquals('fontFamily', $attributes['font_family']);
        $this->assertEquals('fontSize', $attributes['font_size']);
        $this->assertEquals('id', $attributes['id']);
        $this->assertEquals('knownVisitor', $attributes['known_visitor']);
        $this->assertEquals('labelPosition', $attributes['label_position']);
        $this->assertEquals('language', $attributes['language']);
        $this->assertEquals('locale', $attributes['locale']);
        $this->assertEquals('name', $attributes['name']);
        $this->assertEquals('progressiveProfiling', $attributes['progressive_profiling']);
        $this->assertEquals('status', $attributes['status']);
        $this->assertEquals('thankYouList', $attributes['thank_you_list']);
        $this->assertEquals('theme', $attributes['theme']);
        $this->assertEquals('updatedAt', $attributes['updated_at']);
        $this->assertEquals('url', $attributes['url']);
        $this->assertEquals('waitingLabel', $attributes['waiting_label']);
    }
