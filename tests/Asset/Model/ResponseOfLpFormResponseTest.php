...
/**
 * ResponseOfLpFormResponseTest class file.
 *
...
use NecLimDul\MarketoRest\Asset\Model\ResponseOfLpFormResponse;
 ...
 */
#[CoversClass(ResponseOfLpFormResponse::class)]
class ResponseOfLpFormResponseTest extends TestCase
{
    use FakeValuesTrait;

    private ResponseOfLpFormResponse $sot;
    ...
    public function setUp(): void
    {
        ...
        $this->sot = $this->getFakeValue(ResponseOfLpFormResponse::class, null);
    }
     ...
     */
    public function testResponseOfLpFormResponse(): void
    {
        $this->assertInstanceOf(ResponseOfLpFormResponse::class, $this->sot);
    }
    ...
    {
        $this->assertEquals($this->types, ResponseOfLpFormResponse::openAPITypes());
    }
    ...
    {
        $this->assertEquals('ResponseOfLpFormResponse', $this->sot->getModelName());
    }
