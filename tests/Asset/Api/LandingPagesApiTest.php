...
class LandingPagesApiTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = new LandingPagesApi($this->client->reveal());
        $this->setAssertedApiException(ApiException::class);
        // Add a key, so we can assert its included.
        $this->sot->getConfig()->setApiKey('Authorization', 'secure-key');
    }

    public function provideApproveLandingPageUsingPOST(): \Generator
    {
    ...
    public function provideBrowseLandingPagesUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideCloneLandingPageUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideCreateLandingPageUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDeleteLandingPageByIdUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDiscardLandingPageByIdUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetLandingPageByIdUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetLandingPageByNameUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetLandingPageFullContentUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetVariablesUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUnapproveLandingPageByIdUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUpdateLandingPageUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUpdateLandingPageVariableUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
