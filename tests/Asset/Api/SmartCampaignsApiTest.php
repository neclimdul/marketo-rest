...
class SmartCampaignsApiTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = new SmartCampaignsApi($this->client->reveal());
        $this->setAssertedApiException(ApiException::class);
        // Add a key, so we can assert its included.
        $this->sot->getConfig()->setApiKey('Authorization', 'secure-key');
    }

    public function provideActivateSmartCampaignUsingPOST(): \Generator
    {
    ...
    public function provideCloneSmartCampaignUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideCreateSmartCampaignUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDeactivateSmartCampaignUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDeleteSmartCampaignUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetAllSmartCampaignsGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetSmartCampaignByIdUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetSmartCampaignByNameUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetSmartListBySmartCampaignIdUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUpdateSmartCampaignUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
