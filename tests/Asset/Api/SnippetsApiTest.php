...
class SnippetsApiTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sot = new SnippetsApi($this->client->reveal());
        $this->setAssertedApiException(ApiException::class);
        // Add a key, so we can assert its included.
        $this->sot->getConfig()->setApiKey('Authorization', 'secure-key');
    }

    public function provideApproveSnippetUsingPOST(): \Generator
    {
    ...
    public function provideCloneSnippetUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideCreateSnippetUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDeleteSnippetUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideDiscardSnippetUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetDynamicContentUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetSnippetByIdUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetSnippetContentByIdUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetSnippetUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUnapproveSnippetUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUpdateContentUsingPOST1(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUpdateDynamicContentUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideUpdateSnippetUsingPOST(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
