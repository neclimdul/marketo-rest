...
class FilesApiTest extends TestCase
{
    ...
    public function provideCreateFileUsingPOST(): \Generator
    {
    ...
    public function provideGetFileByIdUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetFileByNameUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
    ...
    public function provideGetFilesUsingGET(): \Generator
    {
        yield from $this->provideFakeRequests(
            200,
            [
                '\NecLimDul\MarketoRest\Asset\Model\GetFilesRequest',
                'string',
            ],
            '\NecLimDul\MarketoRest\Asset\Model\ResponseOfFileResponse',
            ['application/json']
