...
class SnippetsApi
{
    ...
    public function cloneSnippetUsingPOSTRequest($id, $clone_snippet_request = null)
    {
        ...
        if (!empty($clone_snippet_request)) {
            $httpBody = ObjectSerializer::handleBody($clone_snippet_request, $headers['Content-Type'] === 'application/json');
        }
    ...
    public function createSnippetUsingPOSTRequest($create_snippet_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($create_snippet_request, $headers['Content-Type'] === 'application/json');
    ...
    public function updateSnippetUsingPOSTRequest($id, $update_snippet_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($update_snippet_request, $headers['Content-Type'] === 'application/json');
