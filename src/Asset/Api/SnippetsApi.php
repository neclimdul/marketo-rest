...
class SnippetsApi
{
    ...
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse';
     ...
     *
     * @param  int $id id (required)
     * @param  string $name Name for the cloned snippet (required)
     * @param  \NecLimDul\MarketoRest\Asset\Model\Folder $folder folder (required)
     * @param  string $description Description of the cloned snippet (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse
     */
    public function cloneSnippetUsingPOST($id, $name, $folder, $description = null)
    {
        list($response) = $this->cloneSnippetUsingPOSTWithHttpInfo($id, $name, $folder, $description);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cloneSnippetUsingPOSTWithHttpInfo($id, $name, $folder, $description = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cloneSnippetUsingPOSTAsync($id, $name, $folder, $description = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cloneSnippetUsingPOSTAsyncWithHttpInfo($id, $name, $folder, $description = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse';
        $request = $this->cloneSnippetUsingPOSTRequest($id, $name, $folder, $description);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cloneSnippetUsingPOSTRequest($id, $name, $folder, $description = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling cloneSnippetUsingPOST'
            );
        }
        // verify the required parameter 'folder' is set
        if ($folder === null || (is_array($folder) && count($folder) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder when calling cloneSnippetUsingPOST'
            );
        }
     ...
     *
     * @param  \NecLimDul\MarketoRest\Asset\Model\Folder $folder folder (required)
     * @param  string $name Name of the snippet (required)
     * @param  string $description Description of the snippet (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse
     */
    public function createSnippetUsingPOST($folder, $name, $description = null)
    {
        list($response) = $this->createSnippetUsingPOSTWithHttpInfo($folder, $name, $description);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSnippetUsingPOSTWithHttpInfo($folder, $name, $description = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSnippetUsingPOSTAsync($folder, $name, $description = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSnippetUsingPOSTAsyncWithHttpInfo($folder, $name, $description = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse';
        $request = $this->createSnippetUsingPOSTRequest($folder, $name, $description);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createSnippetUsingPOSTRequest($folder, $name, $description = null)
    {
        // verify the required parameter 'folder' is set
        if ($folder === null || (is_array($folder) && count($folder) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder when calling createSnippetUsingPOST'
            );
        }
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling createSnippetUsingPOST'
            );
        }
    ...
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetContentResponse';
     ...
     * @param  string $type Type of dynamic content section (optional)
     * @param  string $value Value of the dynamic content section (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfIdResponse
     */
    public function updateDynamicContentUsingPOST($id, $segment_id, $type = null, $value = null)
    {
        list($response) = $this->updateDynamicContentUsingPOSTWithHttpInfo($id, $segment_id, $type, $value);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Asset\Model\ResponseOfIdResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDynamicContentUsingPOSTWithHttpInfo($id, $segment_id, $type = null, $value = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfIdResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDynamicContentUsingPOSTAsync($id, $segment_id, $type = null, $value = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDynamicContentUsingPOSTAsyncWithHttpInfo($id, $segment_id, $type = null, $value = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfIdResponse';
        $request = $this->updateDynamicContentUsingPOSTRequest($id, $segment_id, $type, $value);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateDynamicContentUsingPOSTRequest($id, $segment_id, $type = null, $value = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  int $id id (required)
     * @param  string $description Description of the snippet (optional)
     * @param  string $is_archive Archival status of the snippet (optional)
     * @param  string $name Name of the snippet (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse
     */
    public function updateSnippetUsingPOST($id, $description = null, $is_archive = null, $name = null)
    {
        list($response) = $this->updateSnippetUsingPOSTWithHttpInfo($id, $description, $is_archive, $name);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSnippetUsingPOSTWithHttpInfo($id, $description = null, $is_archive = null, $name = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSnippetUsingPOSTAsync($id, $description = null, $is_archive = null, $name = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSnippetUsingPOSTAsyncWithHttpInfo($id, $description = null, $is_archive = null, $name = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSnippetResponse';
        $request = $this->updateSnippetUsingPOSTRequest($id, $description, $is_archive, $name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateSnippetUsingPOSTRequest($id, $description = null, $is_archive = null, $name = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // form params
        if ($is_archive !== null) {
            $formParams['isArchive'] = ObjectSerializer::toFormValue($is_archive);
        }
        // form params
        if ($name !== null) {
            $formParams['name'] = ObjectSerializer::toFormValue($name);
