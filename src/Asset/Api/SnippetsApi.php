...
class SnippetsApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cloneSnippetUsingPOSTRequest($id, $name, $folder, $description = null)
    {
        // Verify the required parameter 'id' is set.
        if ($id === null || (is_array($id) && empty($id))) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createSnippetUsingPOSTRequest($folder, $name, $description = null)
    {
        // Verify the required parameter 'folder' is set.
        if ($folder === null || (is_array($folder) && empty($folder))) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateDynamicContentUsingPOSTRequest($id, $segment_id, $type = null, $value = null)
    {
        // Verify the required parameter 'id' is set.
        if ($id === null || (is_array($id) && empty($id))) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSnippetUsingPOSTRequest($id, $description = null, $is_archive = null, $name = null)
    {
        // Verify the required parameter 'id' is set.
        if ($id === null || (is_array($id) && empty($id))) {
            throw new \InvalidArgumentException(
