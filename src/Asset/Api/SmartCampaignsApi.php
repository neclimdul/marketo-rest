...
class SmartCampaignsApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cloneSmartCampaignUsingPOSTRequest($id, $folder, $name, $description = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createSmartCampaignUsingPOSTRequest($folder, $name, $description = null)
    {
        // verify the required parameter 'folder' is set
        if ($folder === null || (is_array($folder) && count($folder) === 0)) {
            throw new \InvalidArgumentException(
