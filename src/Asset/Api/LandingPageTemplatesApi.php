...
class LandingPageTemplatesApi
{
     ...
     * @param  string $description Description of the landing page template (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
     */
    public function cloneLpTemplateUsingPOST($id, $folder, $name, $description = null)
    {
        list($response) = $this->cloneLpTemplateUsingPOSTWithHttpInfo($id, $folder, $name, $description);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cloneLpTemplateUsingPOSTWithHttpInfo($id, $folder, $name, $description = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cloneLpTemplateUsingPOSTAsync($id, $folder, $name, $description = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cloneLpTemplateUsingPOSTAsyncWithHttpInfo($id, $folder, $name, $description = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse';
        $request = $this->cloneLpTemplateUsingPOSTRequest($id, $folder, $name, $description);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cloneLpTemplateUsingPOSTRequest($id, $folder, $name, $description = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($folder === null || (is_array($folder) && count($folder) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder when calling cloneLpTemplateUsingPOST'
            );
        }
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling cloneLpTemplateUsingPOST'
            );
        }
     ...
     * @param  string $name Name of the landing page template (required)
     * @param  string $description Description of the landing page template (optional)
     * @param  bool $enable_munchkin Whether to enable munchkin on the derived pages.  Defaults to true (optional)
     * @param  string $template_type Type of template to create.  Defaults to freeForm (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
     */
    public function createLpTemplateUsingPOST($folder, $name, $description = null, $enable_munchkin = null, $template_type = null)
    {
        list($response) = $this->createLpTemplateUsingPOSTWithHttpInfo($folder, $name, $description, $enable_munchkin, $template_type);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLpTemplateUsingPOSTWithHttpInfo($folder, $name, $description = null, $enable_munchkin = null, $template_type = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createLpTemplateUsingPOSTAsync($folder, $name, $description = null, $enable_munchkin = null, $template_type = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createLpTemplateUsingPOSTAsyncWithHttpInfo($folder, $name, $description = null, $enable_munchkin = null, $template_type = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse';
        $request = $this->createLpTemplateUsingPOSTRequest($folder, $name, $description, $enable_munchkin, $template_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createLpTemplateUsingPOSTRequest($folder, $name, $description = null, $enable_munchkin = null, $template_type = null)
    {
        // verify the required parameter 'folder' is set
        if ($folder === null || (is_array($folder) && count($folder) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder when calling createLpTemplateUsingPOST'
            );
        }
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling createLpTemplateUsingPOST'
            );
        }
        ...
        // form params
        if ($enable_munchkin !== null) {
            $formParams['enableMunchkin'] = ObjectSerializer::toFormValue($enable_munchkin);
        }
        // form params
        if ($folder !== null) {
            $formParams['folder'] = ObjectSerializer::toFormValue($folder);
        ...
        if ($template_type !== null) {
            $formParams['templateType'] = ObjectSerializer::toFormValue($template_type);
        }
        // body params
        $_tempBody = null;
     ...
     * @param  string $description Description of the landing page template (optional)
     * @param  bool $enable_munchkin Whether to enable munchkin on the derived pages.  Defaults to true (optional)
     * @param  string $name Name of the landing page template (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse
     */
    public function updateLpTemplateUsingPOST($id, $description = null, $enable_munchkin = null, $name = null)
    {
        list($response) = $this->updateLpTemplateUsingPOSTWithHttpInfo($id, $description, $enable_munchkin, $name);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateLpTemplateUsingPOSTWithHttpInfo($id, $description = null, $enable_munchkin = null, $name = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLpTemplateUsingPOSTAsync($id, $description = null, $enable_munchkin = null, $name = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLpTemplateUsingPOSTAsyncWithHttpInfo($id, $description = null, $enable_munchkin = null, $name = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfLpTemplateResponse';
        $request = $this->updateLpTemplateUsingPOSTRequest($id, $description, $enable_munchkin, $name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateLpTemplateUsingPOSTRequest($id, $description = null, $enable_munchkin = null, $name = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
