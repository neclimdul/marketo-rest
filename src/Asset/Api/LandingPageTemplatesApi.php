...
class LandingPageTemplatesApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cloneLpTemplateUsingPOSTRequest($id, $folder, $name, $description = null)
    {
        // Verify the required parameter 'id' is set.
        if ($id === null || (is_array($id) && empty($id))) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createLpTemplateUsingPOSTRequest($folder, $name, $description = null, $enable_munchkin = null, $template_type = null)
    {
        // Verify the required parameter 'folder' is set.
        if ($folder === null || (is_array($folder) && empty($folder))) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateLpTemplateUsingPOSTRequest($id, $description = null, $enable_munchkin = null, $name = null)
    {
        // Verify the required parameter 'id' is set.
        if ($id === null || (is_array($id) && empty($id))) {
            throw new \InvalidArgumentException(
