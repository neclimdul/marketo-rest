...
class ProgramsApi
{
    ...
    public function cloneProgramUsingPOSTRequest($id, $clone_program_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($clone_program_request, $headers['Content-Type'] === 'application/json');
    ...
    public function createProgramUsingPOSTRequest($create_program_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($create_program_request, $headers['Content-Type'] === 'application/json');
    ...
    public function updateProgramUsingPOSTRequest($id, $update_program_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($update_program_request, $headers['Content-Type'] === 'application/json');
