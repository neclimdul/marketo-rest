...
class FormsApi
{
    ...
    public function cloneLpFormsUsingPOSTRequest($id, $clone_form_request = null)
    {
        ...
        if (!empty($clone_form_request)) {
            $httpBody = ObjectSerializer::handleBody($clone_form_request, $headers['Content-Type'] === 'application/json');
        }
    ...
    public function createLpFormsUsingPOSTRequest($create_form_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($create_form_request, $headers['Content-Type'] === 'application/json');
    ...
    public function updateFormSubmitButtonUsingPOSTRequest($id, $submit_button_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($submit_button_request, $headers['Content-Type'] === 'application/json');
    ...
    public function updateFormsUsingPOSTRequest($id, $update_form_meta_data_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($update_form_meta_data_request, $headers['Content-Type'] === 'application/json');
    ...
    public function updateThankYouPageByIdUsingPOSTRequest($id, $thank_you_page_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($thank_you_page_request, $headers['Content-Type'] === 'application/json');
