...
class SmartListsApi
{
     ...
     * @param  string $name Name for the cloned smart list (required)
     * @param  \NecLimDul\MarketoRest\Asset\Model\Folder $folder folder (required)
     * @param  string $description Description of the cloned smart list (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfSmartListResponse
     */
    public function cloneSmartListUsingPOST($id, $name, $folder, $description = null)
    {
        list($response) = $this->cloneSmartListUsingPOSTWithHttpInfo($id, $name, $folder, $description);
        return $response;
    }
     ...
     */
    public function cloneSmartListUsingPOSTWithHttpInfo($id, $name, $folder, $description = null)
    {
     ...
     */
    public function cloneSmartListUsingPOSTAsync($id, $name, $folder, $description = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cloneSmartListUsingPOSTAsyncWithHttpInfo($id, $name, $folder, $description = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfSmartListResponse';
        $request = $this->cloneSmartListUsingPOSTRequest($id, $name, $folder, $description);
     ...
     */
    protected function cloneSmartListUsingPOSTRequest($id, $name, $folder, $description = null)
    {
        ...
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling cloneSmartListUsingPOST'
            );
        }
        // verify the required parameter 'folder' is set
        if ($folder === null || (is_array($folder) && count($folder) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder when calling cloneSmartListUsingPOST'
            );
        }
