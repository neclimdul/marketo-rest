...
class FoldersApi
{
     ...
     */
    public function createFolderUsingPOSTRequest($name, $parent, $description = null)
    {
        ...
        if ($parent === null || (is_array($parent) && empty($parent))) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateFolderUsingPOSTRequest($id, $type, $description = null, $is_archive = null, $name = null)
    {
        // Verify the required parameter 'id' is set.
        if ($id === null || (is_array($id) && empty($id))) {
            throw new \InvalidArgumentException(
