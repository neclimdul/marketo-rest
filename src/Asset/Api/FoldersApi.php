...
class FoldersApi
{
    ...
    public function createFolderUsingPOSTRequest($create_folder_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($create_folder_request, $headers['Content-Type'] === 'application/json');
    ...
    public function updateFolderUsingPOSTRequest($id, $update_folder_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($update_folder_request, $headers['Content-Type'] === 'application/json');
