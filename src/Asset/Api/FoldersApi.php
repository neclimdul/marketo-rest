...
class FoldersApi
{
     ...
     * Create Folder
     *
     * @param  string $name Name of the Folder (required)
     * @param  \NecLimDul\MarketoRest\Asset\Model\Folder $parent parent (required)
     ...
     */
    public function createFolderUsingPOST($name, $parent, $description = null)
    {
        list($response) = $this->createFolderUsingPOSTWithHttpInfo($name, $parent, $description);
        return $response;
    }
     ...
     *
     * @param  string $name Name of the Folder (required)
     * @param  \NecLimDul\MarketoRest\Asset\Model\Folder $parent (required)
     * @param  string $description Description of the asset (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createFolderUsingPOSTWithHttpInfo($name, $parent, $description = null)
    {
     ...
     */
    public function createFolderUsingPOSTAsync($name, $parent, $description = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createFolderUsingPOSTAsyncWithHttpInfo($name, $parent, $description = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfFolderResponse';
        $request = $this->createFolderUsingPOSTRequest($name, $parent, $description);
     ...
     */
    protected function createFolderUsingPOSTRequest($name, $parent, $description = null)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling createFolderUsingPOST'
            );
        }
        // verify the required parameter 'parent' is set
        if ($parent === null || (is_array($parent) && count($parent) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $parent when calling createFolderUsingPOST'
            );
        }
     ...
     * @param  string $type Type of folder.  &#39;Folder&#39; or &#39;Program&#39; (required)
     * @param  string $description Description of the asset (optional)
     * @param  bool $is_archive Whether the folder is archived or not.  Toggling this value will change the archival status of the folder (optional)
     * @param  string $name Name of the Folder (optional)
     *
     * @throws \NecLimDul\MarketoRest\Asset\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Asset\Model\ResponseOfFolderResponse
     */
    public function updateFolderUsingPOST($id, $type, $description = null, $is_archive = null, $name = null)
    {
        list($response) = $this->updateFolderUsingPOSTWithHttpInfo($id, $type, $description, $is_archive, $name);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Asset\Model\ResponseOfFolderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateFolderUsingPOSTWithHttpInfo($id, $type, $description = null, $is_archive = null, $name = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfFolderResponse';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFolderUsingPOSTAsync($id, $type, $description = null, $is_archive = null, $name = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFolderUsingPOSTAsyncWithHttpInfo($id, $type, $description = null, $is_archive = null, $name = null)
    {
        $returnType = '\NecLimDul\MarketoRest\Asset\Model\ResponseOfFolderResponse';
        $request = $this->updateFolderUsingPOSTRequest($id, $type, $description, $is_archive, $name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateFolderUsingPOSTRequest($id, $type, $description = null, $is_archive = null, $name = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
