...
class TokensApi
{
     ...
     * @param  string $name Name of the token. Max length is 50 characters) (required)
     ...
     */
    public function addTokenTOFolderUsingPOSTRequest($id, $folder_type, $name, $type, $value)
    {
        ...
        if ($folder_type === null || (is_array($folder_type) && empty($folder_type))) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTokenByNameUsingPOSTRequest($id, $folder_type = null, $name = null, $type = null)
    {
        // Verify the required parameter 'id' is set.
        if ($id === null || (is_array($id) && empty($id))) {
            throw new \InvalidArgumentException(
