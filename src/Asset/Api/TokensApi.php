...
class TokensApi
{
    ...
    ): Request
    {
        ...
        $httpBody = ObjectSerializer::toBodyValue($create_token_request, $headers['Content-Type'] === 'application/json');
    ...
    ): Request
    {
        ...
        $httpBody = ObjectSerializer::toBodyValue($delete_token_request, $headers['Content-Type'] === 'application/json');
