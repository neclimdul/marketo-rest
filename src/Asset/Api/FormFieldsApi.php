...
class FormFieldsApi
{
     ...
     * @phpstan-return array{ \NecLimDul\MarketoRest\Asset\Model\ResponseOfLpFormFieldResponse, int, array<array<string>>}
     */
    ...
    ): Request
    {
        ...
        $httpBody = ObjectSerializer::toBodyValue($add_form_field_set_request, $headers['Content-Type'] === 'application/json');
     ...
     * @phpstan-return array{ \NecLimDul\MarketoRest\Asset\Model\ResponseOfFormVisibilityRuleResponse, int, array<array<string>>}
     */
    ...
    ): Request
    {
        ...
        $httpBody = ObjectSerializer::toBodyValue($add_form_field_visibility_request, $headers['Content-Type'] === 'application/json');
    ...
    ): Request
    {
        ...
        $httpBody = ObjectSerializer::toBodyValue($add_rich_text_request, $headers['Content-Type'] === 'application/json');
     ...
     * @phpstan-return array{ \NecLimDul\MarketoRest\Asset\Model\ResponseOfFieldsMetaDataResponse, int, array<array<string>>}
     */
    ...
    ): Request
    {
        ...
        if (!empty($re_arrange_request)) {
            $httpBody = ObjectSerializer::toBodyValue($re_arrange_request, $headers['Content-Type'] === 'application/json');
        }
    ...
    ): Request
    {
        ...
        $httpBody = ObjectSerializer::toBodyValue($update_form_field_request, $headers['Content-Type'] === 'application/json');
