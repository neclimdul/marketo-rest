...
class LandingPageRedirectRulesApi
{
     ...
     */
    protected function createLandingPageRedirectRuleUsingPOSTRequest($hostname, $redirect_from, $redirect_to)
    {
        ...
        if ($redirect_from === null || (is_array($redirect_from) && count($redirect_from) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($redirect_to === null || (is_array($redirect_to) && count($redirect_to) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateLandingPageRedirectRuleUsingPOSTRequest($id, $hostname = null, $redirect_from = null, $redirect_to = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
