...
class SegmentsApi
{
     ...
     */
    protected function getSegmentationUsingGETRequest($status = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSegmentsForSegmentationUsingGETRequest($id, $status = null, $offset = null, $max_return = null)
    {
