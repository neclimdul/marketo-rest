...
class StaticListsApi
{
     ...
     */
    public function createStaticListUsingPOSTRequest($name, $folder, $description = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateStaticListUsingPOSTRequest($id, $description = null, $name = null)
    {
        // Verify the required parameter 'id' is set.
        if ($id === null || (is_array($id) && empty($id))) {
            throw new \InvalidArgumentException(
