...
class EmailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_open_tracking_disabled'] === null) {
            $invalidProperties[] = "'is_open_tracking_disabled' can't be null";
        }
     ...
     * @return bool
     */
    public function getIsOpenTrackingDisabled()
    {
     ...
     * @return self
     */
    public function setIsOpenTrackingDisabled($is_open_tracking_disabled)
    {
