...
/**
 * ResponseOfTagResponseGetAll class file.
 *
 ...
 *
 * @phpstan-type ResponseOfTagResponseGetAllArray array{
 ...
 */
class ResponseOfTagResponseGetAll extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<ResponseOfTagResponseGetAllArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'ResponseOfTagResponseGetAll';
     ...
     * Constructor
     *
     * @param ResponseOfTagResponseGetAllArray $data
