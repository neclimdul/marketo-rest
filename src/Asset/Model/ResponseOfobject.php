 ...
 *
 * @phpstan-type ResponseOfobjectArray array{
 ...
 */
class ResponseOfobject extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<ResponseOfobjectArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'ResponseOfobject';
     ...
     * Constructor
     *
     * @param ResponseOfobjectArray $data
