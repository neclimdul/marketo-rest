...
/**
 * ResponseOfEmailCCFieldsResponse class file.
 *
 ...
 *
 * @phpstan-type ResponseOfEmailCCFieldsResponseArray array{
 ...
 */
class ResponseOfEmailCCFieldsResponse extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<ResponseOfEmailCCFieldsResponseArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'ResponseOfEmailCCFieldsResponse';
     ...
     * Constructor
     *
     * @param ResponseOfEmailCCFieldsResponseArray $data
