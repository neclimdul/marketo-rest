...
/**
 * CreateSnippetRequest class file.
 *
 ...
 *
 * @phpstan-type CreateSnippetRequestArray array{
 *     description?: ?string,
 ...
 */
class CreateSnippetRequest extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<CreateSnippetRequestArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'CreateSnippetRequest';
     ...
     * Constructor
     *
     * @param CreateSnippetRequestArray $data
