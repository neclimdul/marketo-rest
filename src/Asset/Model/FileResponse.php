...
class FileResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'created_at' => '\DateTime',
        'description' => 'string',
        'folder' => '\MarketoRest\Asset\Model\FileFolder',
        'id' => 'int',
        'mime_type' => 'string',
        'name' => 'string',
        'size' => 'int',
     ...
     * Gets folder
     *
     * @return \MarketoRest\Asset\Model\FileFolder
     */
     ...
     * Sets folder
     *
     * @param \MarketoRest\Asset\Model\FileFolder $folder JSON representation of parent folder, with members 'id', and 'type' which may be 'Folder' or 'Program'
     *
     * @return $this
     */
