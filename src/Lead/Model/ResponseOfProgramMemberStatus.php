 ...
 */
class ResponseOfProgramMemberStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseOfProgramMemberStatus';
