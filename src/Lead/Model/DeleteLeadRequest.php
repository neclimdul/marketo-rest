 ...
 */
class DeleteLeadRequest extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<DeleteLeadRequestArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'DeleteLeadRequest';
     ...
     * Constructor
     *
     * @param DeleteLeadRequestArray $data
