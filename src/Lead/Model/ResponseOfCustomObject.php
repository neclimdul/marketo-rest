...
class ResponseOfCustomObject implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'request_id' => 'string',
        'result' => '\MarketoRest\Lead\Model\CustomObject[]',
        'success' => 'bool',
     ...
     * Sets result
     *
     * @param \MarketoRest\Lead\Model\CustomObject[] $result Array of results for individual records in the operation, may be empty
     *
     * @return $this
     */
