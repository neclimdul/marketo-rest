...
/**
 * DeleteSalesPersonRequest class file.
 *
 ...
 *
 * @phpstan-type DeleteSalesPersonRequestArray array{
 *     delete_by?: ?string,
 ...
 */
class DeleteSalesPersonRequest extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<DeleteSalesPersonRequestArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'DeleteSalesPersonRequest';
     ...
     * Constructor
     *
     * @param DeleteSalesPersonRequestArray $data
