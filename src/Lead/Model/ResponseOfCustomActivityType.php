 ...
 */
class ResponseOfCustomActivityType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseOfCustomActivityType';
