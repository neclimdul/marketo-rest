...
/**
 * AddNamedAccountListMemberRequest class file.
 *
 ...
 */
class AddNamedAccountListMemberRequest extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<AddNamedAccountListMemberRequestArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'AddNamedAccountListMemberRequest';
     ...
     * Constructor
     *
     * @param AddNamedAccountListMemberRequestArray $data
