 ...
 */
class LeadFormFields extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<LeadFormFieldsArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'LeadFormFields';
     ...
     * Constructor
     *
     * @param LeadFormFieldsArray $data
