 ...
 */
class ResponseOfListOperationOutputData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseOfListOperationOutputData';
