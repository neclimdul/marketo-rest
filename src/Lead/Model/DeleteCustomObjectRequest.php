 ...
 */
class DeleteCustomObjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteCustomObjectRequest';
     ...
     * Sets delete_by
     *
     * @param string $delete_by Field to delete records by.  Permissible values are idField or dedupeFields as indicated by the result of the corresponding describe record
     *
     * @return self
     */
