 ...
 *
 * @phpstan-type DeleteCustomObjectRequestArray array{
 *     delete_by?: ?string,
 ...
 */
class DeleteCustomObjectRequest extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<DeleteCustomObjectRequestArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'DeleteCustomObjectRequest';
     ...
     * Constructor
     *
     * @param DeleteCustomObjectRequestArray $data
