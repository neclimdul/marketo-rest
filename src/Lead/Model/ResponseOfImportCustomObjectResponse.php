 ...
 */
class ResponseOfImportCustomObjectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseOfImportCustomObjectResponse';
