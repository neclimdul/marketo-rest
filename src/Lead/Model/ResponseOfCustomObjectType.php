...
/**
 * ResponseOfCustomObjectType class file.
 *
 ...
 *
 * @phpstan-type ResponseOfCustomObjectTypeArray array{
 ...
 */
class ResponseOfCustomObjectType extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<ResponseOfCustomObjectTypeArray>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'ResponseOfCustomObjectType';
     ...
     * Constructor
     *
     * @param ResponseOfCustomObjectTypeArray $data
