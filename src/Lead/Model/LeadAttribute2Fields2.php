...
/**
 * LeadAttribute2Fields2 class file.
 *
 ...
 *
 * @phpstan-type LeadAttribute2Fields2Array array{
 *     name: string,
 *     display_name: string,
 *     data_type: string,
 *     length?: ?int,
 ...
 */
class LeadAttribute2Fields2 extends ModelBase implements ModelInterface, \ArrayAccess, \JsonSerializable, \Stringable
{
    use OpenApiAttributesTrait;
    use AdditionalPropertiesTrait;

    /**
     * @use \Neclimdul\OpenapiPhp\Helper\Model\ArrayAccessTrait<LeadAttribute2Fields2Array>
     */
     ...
     * {@inheritDoc}
     */
    protected static string $openAPIModelName = 'LeadAttribute2Fields2';
     ...
     * Constructor
     *
     * @param LeadAttribute2Fields2Array $data
