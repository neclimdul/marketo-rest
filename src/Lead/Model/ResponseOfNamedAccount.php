...
class ResponseOfNamedAccount implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'request_id' => 'string',
        'result' => '\MarketoRest\Lead\Model\NamedAccount[]',
        'success' => 'bool',
     ...
     * Sets result
     *
     * @param \MarketoRest\Lead\Model\NamedAccount[] $result Array of results for individual records in the operation, may be empty
     *
     * @return $this
     */
