 ...
 */
class ResponseOfImportLeadResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseOfImportLeadResponse';
