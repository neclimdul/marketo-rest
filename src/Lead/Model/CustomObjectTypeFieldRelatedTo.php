 ...
 */
class CustomObjectTypeFieldRelatedTo extends ModelBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CustomObjectTypeFieldRelatedTo';
