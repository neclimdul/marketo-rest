...
class ResponseOfCustomActivity implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'request_id' => 'string',
        'result' => '\MarketoRest\Lead\Model\CustomActivity[]',
        'success' => 'bool',
     ...
     * Sets result
     *
     * @param \MarketoRest\Lead\Model\CustomActivity[] $result Array of results for individual records in the operation, may be empty
     *
     * @return $this
     */
