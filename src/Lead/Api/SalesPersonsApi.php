...
class SalesPersonsApi
{
    ...
    public function deleteSalesPersonUsingPOSTRequest($delete_sales_person_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($delete_sales_person_request, $headers['Content-Type'] === 'application/json');
    ...
    public function syncSalesPersonsUsingPOSTRequest($sync_sales_person_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($sync_sales_person_request, $headers['Content-Type'] === 'application/json');
