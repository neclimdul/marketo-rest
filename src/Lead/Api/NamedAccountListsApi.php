...
class NamedAccountListsApi
{
    ...
    public function addNamedAccountListMembersUsingPOSTRequest($id, $add_named_account_list_member_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($add_named_account_list_member_request, $headers['Content-Type'] === 'application/json');
    ...
    public function deleteNamedAccountListsUsingPOSTRequest($delete_named_account_list_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($delete_named_account_list_request, $headers['Content-Type'] === 'application/json');
    ...
    public function removeNamedAccountListMembersUsingPOSTRequest($id, $remove_named_account_list_member_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($remove_named_account_list_member_request, $headers['Content-Type'] === 'application/json');
    ...
    public function syncNamedAccountListsUsingPOSTRequest($sync_named_account_list_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($sync_named_account_list_request, $headers['Content-Type'] === 'application/json');
