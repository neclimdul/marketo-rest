...
class NamedAccountsApi
{
     ...
     *
     * @param  \MarketoRest\Lead\Model\DeleteNamedAccountRequest $delete_account_request deleteAccountRequest (required)
     *
     ...
     */
    protected function deleteNamedAccountsUsingPOSTRequest($delete_account_request)
    {
        // verify the required parameter 'delete_account_request' is set
        if ($delete_account_request === null || (is_array($delete_account_request) && count($delete_account_request) === 0)) {
        ...
        if (isset($delete_account_request)) {
            $_tempBody = $delete_account_request;
        }
     ...
     * Sync NamedAccounts
     *
     * @param  \MarketoRest\Lead\Model\SyncNamedAccountRequest $sync_account_request syncAccountRequest (required)
     *
     * @throws \MarketoRest\Lead\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MarketoRest\Lead\Model\ResponseOfNamedAccount
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function syncNamedAccountsUsingPOSTRequest($sync_account_request)
    {
        // verify the required parameter 'sync_account_request' is set
        if ($sync_account_request === null || (is_array($sync_account_request) && count($sync_account_request) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($sync_account_request)) {
            $_tempBody = $sync_account_request;
        }
