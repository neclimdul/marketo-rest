...
class NamedAccountsApi
{
     ...
     *
     * @param  \NecLimDul\MarketoRest\Lead\Model\DeleteNamedAccountRequest $delete_named_account_request deleteAccountRequest (required)
     *
     * @throws \NecLimDul\MarketoRest\Lead\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount
     */
    public function deleteNamedAccountsUsingPOST($delete_named_account_request)
    {
        list($response) = $this->deleteNamedAccountsUsingPOSTWithHttpInfo($delete_named_account_request);
        return $response;
    }
     ...
     */
    public function deleteNamedAccountsUsingPOSTWithHttpInfo($delete_named_account_request)
    {
        $returnType = '\NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount';
        $request = $this->deleteNamedAccountsUsingPOSTRequest($delete_named_account_request);
     ...
     */
    public function deleteNamedAccountsUsingPOSTAsync($delete_named_account_request)
    {
        return $this->deleteNamedAccountsUsingPOSTAsyncWithHttpInfo($delete_named_account_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteNamedAccountsUsingPOSTAsyncWithHttpInfo($delete_named_account_request)
    {
        $returnType = '\NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount';
        $request = $this->deleteNamedAccountsUsingPOSTRequest($delete_named_account_request);
     ...
     */
    protected function deleteNamedAccountsUsingPOSTRequest($delete_named_account_request)
    {
        // verify the required parameter 'delete_named_account_request' is set
        if ($delete_named_account_request === null || (is_array($delete_named_account_request) && count($delete_named_account_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $delete_named_account_request when calling deleteNamedAccountsUsingPOST'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($delete_named_account_request)) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function describeUsingGET3Request()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getNamedAccountsUsingGETRequest($filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null)
    {
     ...
     * Sync NamedAccounts
     *
     * @param  \NecLimDul\MarketoRest\Lead\Model\SyncNamedAccountRequest $sync_named_account_request syncAccountRequest (required)
     *
     * @throws \NecLimDul\MarketoRest\Lead\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount
     */
    public function syncNamedAccountsUsingPOST($sync_named_account_request)
    {
        list($response) = $this->syncNamedAccountsUsingPOSTWithHttpInfo($sync_named_account_request);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncNamedAccountsUsingPOSTWithHttpInfo($sync_named_account_request)
    {
        $returnType = '\NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount';
        $request = $this->syncNamedAccountsUsingPOSTRequest($sync_named_account_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncNamedAccountsUsingPOSTAsync($sync_named_account_request)
    {
        return $this->syncNamedAccountsUsingPOSTAsyncWithHttpInfo($sync_named_account_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncNamedAccountsUsingPOSTAsyncWithHttpInfo($sync_named_account_request)
    {
        $returnType = '\NecLimDul\MarketoRest\Lead\Model\ResponseOfNamedAccount';
        $request = $this->syncNamedAccountsUsingPOSTRequest($sync_named_account_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function syncNamedAccountsUsingPOSTRequest($sync_named_account_request)
    {
        // verify the required parameter 'sync_named_account_request' is set
        if ($sync_named_account_request === null || (is_array($sync_named_account_request) && count($sync_named_account_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sync_named_account_request when calling syncNamedAccountsUsingPOST'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($sync_named_account_request)) {
            $_tempBody = $sync_named_account_request;
        }
