...
class NamedAccountsApi
{
    ...
    public function deleteNamedAccountsUsingPOSTRequest($delete_account_request)
    {
        ...
        if ($delete_account_request === null || (is_array($delete_account_request) && empty($delete_account_request))) {
    ...
    public function syncNamedAccountsUsingPOSTRequest($sync_account_request)
    {
        ...
        if ($sync_account_request === null || (is_array($sync_account_request) && empty($sync_account_request))) {
            throw new \InvalidArgumentException(
