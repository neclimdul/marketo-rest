...
class NamedAccountsApi
{
    ...
    public function deleteNamedAccountsUsingPOSTRequest($delete_account_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($delete_account_request, $headers['Content-Type'] === 'application/json');
    ...
    public function syncNamedAccountsUsingPOSTRequest($sync_account_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($sync_account_request, $headers['Content-Type'] === 'application/json');
