...
class ActivitiesApi
{
    ...
    public function addCustomActivityUsingPOSTRequest($custom_activity_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($custom_activity_request, $headers['Content-Type'] === 'application/json');
    ...
    public function createCustomActivityTypeAttributesUsingPOSTRequest($api_name, $custom_activity_type_attribute_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($custom_activity_type_attribute_request, $headers['Content-Type'] === 'application/json');
    ...
    public function createCustomActivityTypeUsingPOSTRequest($custom_activity_type_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($custom_activity_type_request, $headers['Content-Type'] === 'application/json');
