...
class CompaniesApi
{
    ...
    public function deleteCompaniesUsingPOSTRequest($delete_company_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($delete_company_request, $headers['Content-Type'] === 'application/json');
    ...
    public function syncCompaniesUsingPOSTRequest($sync_company_request)
    {
        ...
        $httpBody = ObjectSerializer::handleBody($sync_company_request, $headers['Content-Type'] === 'application/json');
