...
class CustomObjectsApi
{
    ...
    public function addCustomObjectTypeFieldsUsingPOSTRequest($api_name, $add_custom_object_type_fields_request)
    {
        ...
        if ($add_custom_object_type_fields_request === null || (is_array($add_custom_object_type_fields_request) && empty($add_custom_object_type_fields_request))) {
            throw new \InvalidArgumentException(
    ...
    public function deleteCustomObjectTypeFieldsUsingPOSTRequest($api_name, $delete_custom_object_type_fields_request)
    {
        ...
        if ($delete_custom_object_type_fields_request === null || (is_array($delete_custom_object_type_fields_request) && empty($delete_custom_object_type_fields_request))) {
            throw new \InvalidArgumentException(
    ...
    public function deleteCustomObjectsUsingPOSTRequest($custom_object_name, $delete_custom_object_request = null)
    {
        ...
        if ($custom_object_name === null || (is_array($custom_object_name) && empty($custom_object_name))) {
            throw new \InvalidArgumentException(
     ...
     * @return \NecLimDul\MarketoRest\Lead\Model\ResponseOfCustomObject
     */
    public function getCustomObjectsUsingGET($custom_object_name, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null, $custom_object_lookup_request = null)
    {
        list($response) = $this->getCustomObjectsUsingGETWithHttpInfo($custom_object_name, $filter_type, $filter_values, $fields, $batch_size, $next_page_token, $custom_object_lookup_request);
        return $response;
    }
     ...
     * @return array of \NecLimDul\MarketoRest\Lead\Model\ResponseOfCustomObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomObjectsUsingGETWithHttpInfo($custom_object_name, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null, $custom_object_lookup_request = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomObjectsUsingGETAsync($custom_object_name, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null, $custom_object_lookup_request = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomObjectsUsingGETAsyncWithHttpInfo($custom_object_name, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null, $custom_object_lookup_request = null)
    {
        $request = $this->getCustomObjectsUsingGETRequest($custom_object_name, $filter_type, $filter_values, $fields, $batch_size, $next_page_token, $custom_object_lookup_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomObjectsUsingGETRequest($custom_object_name, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null, $custom_object_lookup_request = null)
    {
        // Verify the required parameter 'custom_object_name' is set.
        if ($custom_object_name === null || (is_array($custom_object_name) && empty($custom_object_name))) {
            throw new \InvalidArgumentException(
    ...
    public function listCustomObjectTypesUsingGETRequest($names = null, $state = null)
    {
        ...
        // Query parameters.
        $queryParams += ObjectSerializer::processQuery('names', $names, 'form');
        if (is_array($state)) {
            $state = ObjectSerializer::serializeCollection($state, '', true);
        }
        $queryParams['state'] = $state;
    ...
    public function syncCustomObjectTypeUsingPOSTRequest($sync_custom_object_type_request)
    {
        ...
        if ($sync_custom_object_type_request === null || (is_array($sync_custom_object_type_request) && empty($sync_custom_object_type_request))) {
            throw new \InvalidArgumentException(
    ...
    public function updateCustomObjectTypeFieldUsingPOSTRequest($api_name, $field_api_name, $update_custom_object_type_field_request)
    {
        ...
        if ($update_custom_object_type_field_request === null || (is_array($update_custom_object_type_field_request) && empty($update_custom_object_type_field_request))) {
            throw new \InvalidArgumentException(
