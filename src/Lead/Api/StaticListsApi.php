...
class StaticListsApi
{
     ...
     */
    protected function addLeadsToListUsingPOSTRequest($list_id, $id = null, $list_operation_request = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function areLeadsMemberOfListUsingGETRequest($list_id, $id = null, $list_operation_request = null)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function removeLeadsFromListUsingDELETERequest($list_id, $id, $list_operation_request)
    {
        // verify the required parameter 'list_id' is set
        if ($list_id === null || (is_array($list_id) && count($list_id) === 0)) {
            throw new \InvalidArgumentException(
