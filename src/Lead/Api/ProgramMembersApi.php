...
class ProgramMembersApi
{
     ...
     *
     * @param  int $program_id The id of target program. (required)
     * @param  string $filter_type The program member field to filter on.  Any custom field (string or integer types only) or any searchable field.  Searchable fields can be obtained via the &lt;a href&#x3D;\&quot;/rest-api/endpoint-reference/lead-database-endpoint-reference/#/Leads/describeProgramMemberUsingGET2\&quot;&gt;Describe Program Member&lt;/a&gt; endpoint. (required)
     ...
     */
    public function getProgramMembersUsingGET($program_id, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null)
    {
        list($response) = $this->getProgramMembersUsingGETWithHttpInfo($program_id, $filter_type, $filter_values, $fields, $batch_size, $next_page_token);
        return $response;
    }
     ...
     */
    public function getProgramMembersUsingGETWithHttpInfo($program_id, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null)
    {
        $request = $this->getProgramMembersUsingGETRequest($program_id, $filter_type, $filter_values, $fields, $batch_size, $next_page_token);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProgramMembersUsingGETAsync($program_id, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null)
    {
        return $this->getProgramMembersUsingGETAsyncWithHttpInfo($program_id, $filter_type, $filter_values, $fields, $batch_size, $next_page_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProgramMembersUsingGETAsyncWithHttpInfo($program_id, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null)
    {
        $request = $this->getProgramMembersUsingGETRequest($program_id, $filter_type, $filter_values, $fields, $batch_size, $next_page_token);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProgramMembersUsingGETRequest($program_id, $filter_type, $filter_values, $fields = null, $batch_size = null, $next_page_token = null)
    {
        // Verify the required parameter 'program_id' is set.
        if ($program_id === null || (is_array($program_id) && empty($program_id))) {
            throw new \InvalidArgumentException(
