...
class ObjectSerializer
{
     ...
     *
     * @param \NecLimDul\MarketoRest\Identity\Model\ModelInterface|scalar $value a string which will be part of the header.
     *
     ...
     * @throws \NecLimDul\MarketoRest\Identity\ApiException
     */
    public static function deserialize($data, string $type, array $httpHeaders = [])
    {
        if (null === $data) {
            return null;
        }
    ...
    public static function createRequest(
        ...
        $query = array_filter($query, $not_null);
        $query = Query::build($query);
        $headers = array_filter($headers, $not_null);
        $form = array_filter($form, $not_null);
